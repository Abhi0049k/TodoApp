    ...
    return (
        <div className="border bg-white dark:bg-gray-800 dark:border-gray-700 h-14 flex px-10 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
                {user && (
                    <span className="text-gray-800 dark:text-white text-lg font-semibold mr-3">
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-white px-3 py-1 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-300"
                >
                    <IoLogOutOutline className="text-xl mr-2" /> Logout
                </button>
            </div>
        </div>
    );
