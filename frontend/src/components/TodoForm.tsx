...
const TodoForm: FC = () => {
    ...
    return (
        ...
        // </div>
        <div className="w-[30%]">
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 h-fit border border-gray-100 backdrop-blur-sm">
